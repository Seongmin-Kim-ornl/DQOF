...
backend = AerSimulator(method='automatic') #service.backend(name="ibm_sherbrooke")
...
def solve_H1(H, num_parallel):
    ...
    #print(f"solver1: most_likely_bitstring: {most_likely_bitstring}, qpu usage: {qpu_usage}, queue: {queue_time}, elapsed time: {caltime}")
